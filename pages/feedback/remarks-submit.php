    ...
    <form method="POST" action="/controllers/submit-form.php" class="bg-white border-2 border-emerald-800 rounded-xl shadow-lg p-6 sm:p-10 max-w-2xl w-full space-y-8">
      <section class="js-remarks-form space-y-6">
        ...
        <div class="space-y-4">
          ...
          <textarea id="remarks" name="remarks" rows="5" class="w-full border-2 rounded-lg p-2" placeholder="<?= $labels['placeholder_remarks'] ?? 'Write your comments here (optional)' ?>"></textarea>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4 pt-6">
          ...
          <button type="submit" class="bg-emerald-800 text-white px-6 py-2 rounded-md w-full sm:w-1/2 hover:bg-emerald-600">
