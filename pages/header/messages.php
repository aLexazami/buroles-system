...
<body class="bg-gray-200 min-h-screen">
  ...
  <main class=" grid grid-cols-[248px_1fr]  min-h-screen">
    ...
    <section class="m-4">
      ...
      switch ($originalRole) {
        case 1:
      include __DIR__ . '/../partials/message/staff-messages-view.php';
      break;
        case 2:
      include __DIR__ . '/../partials/message/admin-messages-view.php';
      break;
        case 99:
      include __DIR__ . '/../partials/message/super-admin-messages-view.php';
      break;
        default:
      echo "<p>Role not recognized.</p>";
      }
