...
?>
  <div class="hidden lg:flex items-center space-x-2 text-xs font-medium text-white bg-emerald-700 px-3 py-1 rounded-full shadow-sm">
    <span class="inline-block w-2 h-2 rounded-full bg-emerald-300"></span>
    <span>Acting as <strong><?= $roleLabel ?></strong></span>
  </div>
<?php endif; ?>